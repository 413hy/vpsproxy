...
if [ -d /root/.codex/skills/vps-proxy-task-diagnosis ]; then
  mv /root/.codex/skills/vps-proxy-task-diagnosis "/root/.codex/skills/vps-proxy-task-diagnosis.removed.$(date +%Y%m%d%H%M%S)"
fi
